...
TMM normalization is not guaranteed to satisfy subcompositional coherance.  This is because the selection of genes to be measured, the subcomposition, can determine the final normalization factor calculated.
