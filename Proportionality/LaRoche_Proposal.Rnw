...
Martin-Fernandez et al. (2000) address this issue through a additive-multiplicative hybrid transformation :
\begin{equation}
r_j = \left\{
\begin{array}{ll}
c_j, & \text{ if } x_j = 0,\\
